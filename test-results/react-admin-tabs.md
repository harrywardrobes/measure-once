...
|---|---|---|---|
| PASS | GET /react/main.js serves the built bundle | status=200 with non-empty body | status=200 length=165723 |
...
| PASS | #tab-designsystem renders DesignSystemPage sections (.ds-section) | at least one .ds-section inside #tab-designsystem | appeared=true sectionCount=11 |
