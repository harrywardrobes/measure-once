...
const ROUTES = [
  ...
  { method: 'GET',    path: '/api/deals',                     level: 'manager', needsHubspot: true },
  { method: 'GET',    path: '/api/deals/0',                   level: 'manager', needsHubspot: true },
  { method: 'GET',    path: '/api/deals/0/notes',             level: 'manager', needsHubspot: true },
  { method: 'GET',    path: '/api/contacts-all',              level: 'auth',    needsHubspot: true },
  { method: 'GET',    path: '/api/open-leads',                level: 'auth',    needsHubspot: true },
  { method: 'GET',    path: '/api/project-contacts',          level: 'auth',    needsHubspot: true },
  ...
  { method: 'POST',   path: '/api/card-actions/open-deal/deposit-invoice-email-preview', level: 'member', body: { firstName: 'Test', depositPercent: '10' } },
  { method: 'POST',   path: '/api/card-actions/deposit-invoice',                    level: 'manager', body: { contactId: '0' }, needsHubspot: true },
  ...
  { method: 'POST',   path: '/api/design-visits/0/photos/resign', level: 'member', body: {} },
  ...
  { method: 'POST',   path: '/api/admin/email-templates/customer_invite/preview', level: 'admin', body: { subject: 'x', body_text: '', body_html: '', footer_text: '' } },
  { method: 'GET',    path: '/api/admin/nav-role-configs',                     level: 'admin' },
  { method: 'PATCH',  path: '/api/admin/nav-role-config/__default__',          level: 'admin', body: { primary_keys: ['home', 'projects', 'trades'] } },
  ...
  { method: 'GET',    path: '/api/admin/catalog/suppliers',                    level: 'admin' },
  ...
  { method: 'DELETE', path: '/api/admin/catalog/handles/0',                    level: 'admin' },
  { method: 'POST',   path: '/api/admin/catalog/handles/upload-image',         level: 'admin', body: {} },
  { method: 'GET',    path: '/api/admin/catalog/ranges',                       level: 'admin' },
  { method: 'POST',   path: '/api/admin/catalog/ranges',                       level: 'admin', body: {} },
  { method: 'PATCH',  path: '/api/admin/catalog/ranges/0',                     level: 'admin', body: {} },
  { method: 'DELETE', path: '/api/admin/catalog/ranges/0',                     level: 'admin' },
  { method: 'GET',    path: '/api/admin/catalog/doors',                        level: 'admin' },
  { method: 'POST',   path: '/api/admin/catalog/doors',                        level: 'admin', body: {} },
  { method: 'PATCH',  path: '/api/admin/catalog/doors/0',                      level: 'admin', body: {} },
  { method: 'DELETE', path: '/api/admin/catalog/doors/0',                      level: 'admin' },
  { method: 'POST',   path: '/api/admin/catalog/doors/upload-image',           level: 'admin', body: {} },
