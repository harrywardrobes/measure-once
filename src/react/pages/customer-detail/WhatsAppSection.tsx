        ...
        <div style={{ padding: '18px 20px' }}>
          ...
          <div style={{ display: 'flex', gap: 0, border: '1px solid var(--border-soft)', borderRadius: 8, overflow: 'hidden', marginBottom: 16 }}>
            <button id="wa-tab-template" onClick={() => setMode('template')}
              style={{ flex: 1, padding: '8px 0', fontSize: '0.82rem', fontWeight: 600, border: 'none', cursor: 'pointer', transition: 'background 0.15s', background: mode === 'template' ? '#f0f9ff' : 'var(--surface-card)' }}>
              Template
            </button>
            <button id="wa-tab-freeform" onClick={() => setMode('freeform')}
              style={{ flex: 1, padding: '8px 0', fontSize: '0.82rem', fontWeight: 600, border: 'none', borderLeft: '1px solid var(--border-soft)', cursor: 'pointer', transition: 'background 0.15s', background: mode === 'freeform' ? '#f0f9ff' : 'var(--surface-card)' }}>
              Free-form
            </button>
          </div>
