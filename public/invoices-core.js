...
function renderInvoicePanelBody() {
  ...
  body.innerHTML = `
    ...
    ${window.__moHeaderUser?.privilege_level === 'admin' ? `<div class="inv-section">
    ...
    <div class="inv-section inv-actions-row">
      <div>
        ...
        <div class="inv-actions-btns">
          ...
          ${window.__moHeaderUser?.privilege_level === 'admin' ? `<button class="inv-btn inv-btn-secondary" id="inv-send-btn" onclick="sendInvoice()">
            <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
